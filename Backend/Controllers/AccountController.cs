...
namespace Backend.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                if (!await UserManager.IsEmailConfirmedAsync(user.Id))
                {
                    ...
                    ViewBag.errorMessage = "Debe verificar su correo electrónico para iniciar sesión, " 
                        + "verifique su bandeja de entrada. Verifique también su "
        ...
        private async void SendVerifyCode(string userId)
        {
        ...
        //            ViewBag.Message = "Verifique su correo electrónico y confirme su cuenta, debe estar "
        //                            + "confirmado antes de poder iniciar sesión. Verifique también su "
        //                            + "bandeja de correo no deseado.";
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var callbackUrl = Url.Action("ResetPassword", "Account"
                    , new { userId = user.Id, code = code }
                    , protocol: Request.Url.Scheme);
                await UserManager.SendEmailAsync(user.Id, "Restablecer contraseña"
