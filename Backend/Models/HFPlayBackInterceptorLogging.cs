...
{
    public class HFPlayBackInterceptorLogging : DbCommandInterceptor
    {
            ...
            DbCommandInterceptionContext<object> interceptionContext)
        {
            ...
            {
                _logger.TraceApi("SQL Database", "HFPlayBackInterceptor.ScalarExecuted",
            ...
            DbCommandInterceptionContext<int> interceptionContext)
        {
            ...
            {
                _logger.TraceApi("SQL Database", "HFPlayBackInterceptor.NonQueryExecuted",
                    _stopwatch.Elapsed, "Command: {0}: ", command.CommandText);
            }
            ...
            DbCommandInterceptionContext<DbDataReader> interceptionContext)
        {
            ...
            {
                _logger.TraceApi("SQL Database", "HFPlayBackInterceptor.ReaderExecuted"
                    , _stopwatch.Elapsed, "Command: {0}: ", command.CommandText);
            }
